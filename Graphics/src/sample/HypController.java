...
public class HypController {
    ...
    public HypController(Controller controller) throws IOException {
        this.controller = controller;

        FXMLLoader loader = new FXMLLoader(getClass().getResource("Hyperbola.fxml"));
        loader.setController(this);
        Parent root = loader.load();
        Stage thisStage = new Stage();
        thisStage.setScene(new Scene(root, 350, 250));
        thisStage.setTitle("New hyperbola");
        thisStage.show();
    }
    @FXML
    void initialize() {
